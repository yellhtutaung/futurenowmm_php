...
<!--    <div class="row mobile-hide">-->
        <div class="cat-row flex-wrap d-flex justify-content-between align-items-center">
            <a href="javascript:void(0)" onclick="projectTab('all-project');" id="all-project" class="text-white my-4 animatable fadeInUp fn-paragraph-font"  >All Projects</a>
...
<!--    </div>-->
    ...
    <div class="row">
        ...
        <div id="div-printing-design" class="col-sm-12 col-md-6 mb-5 animate__animated animate__fadeInUp">
            <div class="project-img-control overflow-hidden">
...
<script>
    ...
    const selectorArr = ["all-project","brand-identity","marketing","ui-ux","printing-design",
     "production","other"];
