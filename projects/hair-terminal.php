    ...
    <div class="container-fluid px-0 mx-0">
        <div id="scroll-up-div" class="row" style="margin: 20% 0;" >
            <div class="col-md-6 col-lg-6 col-sm-12 px-0 mx-0 once-text-content-append" >
                ...
                <p class=" fn-paragraph-font">High-end luxury salon</p>
            </div>
            <div class="col-sm-12 col-md-6 col-lg-6">
                <div class="row detail-works-sm-margin">
                    ...
                    <div class="col-sm-6 col-md-4 sm-top-divider px-0 mx-0">
                        ...
                        <p class="mb-0 text-white fn-paragraph-font text-right">Beauty & Salon</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-sm-12 col-md-6 ">
            <div class="universal-img-container"  data-aos="fade-up" data-aos-duration="1500">
                <img class="w-100 h-auto" src="<?php echo $domainUrl; ?>/assets/images/projects/hair_terminal/1.jpg" alt="">
            </div>
        </div>
        <div class="col-sm-12 col-md-6 mt-4">
            <div class="universal-img-container"  data-aos="fade-up" data-aos-duration="1500">
                <img class="w-100 h-auto" src="<?php echo $domainUrl; ?>/assets/images/projects/hair_terminal/2.jpg" alt="">
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-12 col-md-8 mt-4">
            <div class="universal-img-container"  data-aos="fade-up" data-aos-duration="1500">
                <img class="w-100 h-auto" src="<?php echo $domainUrl; ?>/assets/images/projects/hair_terminal/3.png" alt="">
            </div>
        </div>
        <div class="col-sm-12 col-md-4 mt-4">
            <div class="universal-img-container"  data-aos="fade-up" data-aos-duration="1500">
                <img class="w-100 h-auto" src="<?php echo $domainUrl; ?>/assets/images/projects/hair_terminal/4.jpg" alt="">
            </div>
        </div>
    </div>
    <div class="universal-img-container mt-4"  data-aos="fade-up" data-aos-duration="1500">
        <img class="w-100 h-auto" src="<?php echo $domainUrl; ?>/assets/images/projects/hair_terminal/5.jpg" alt="">
    </div>
    <div class="row">
        <div class="col-sm-12 col-md-4 mt-4">
            <div class="universal-img-container"  data-aos="fade-up" data-aos-duration="1500">
                <img class="w-100 h-auto" src="<?php echo $domainUrl; ?>/assets/images/projects/hair_terminal/6.png" alt="">
            </div>
            <div class="universal-img-container mt-4"  data-aos="fade-up" data-aos-duration="1500">
                <img class="w-100 h-auto" src="<?php echo $domainUrl; ?>/assets/images/projects/hair_terminal/7.png" alt="">
            </div>
        </div>
        <div class="col-sm-12 col-md-8 mt-4">
            <div class="universal-img-container"  data-aos="fade-up" data-aos-duration="1500">
                <img class="w-100 h-auto" src="<?php echo $domainUrl; ?>/assets/images/projects/hair_terminal/8.jpg" alt="">
            </div>
        </div>
    </div>
    <div class="universal-img-container mt-4"  data-aos="fade-up" data-aos-duration="1500">
        <img class="w-100 h-auto" src="<?php echo $domainUrl; ?>/assets/images/projects/hair_terminal/9.jpg" alt="">
    </div>
...
<div class="project-overlay" style="height: 0%;" >
    <div class="theme-container mt-5">
        ...
        <div class="row" style="margin-top: 150px">
            <div class="col-sm-12 col-md-6">
                <p class="fn-title-font ">Hair Terminal</p>
                <div class="description-section">
                    <p class="fn-paragraph-font my-5 opacity-05">
                        Maxi Aluminium is a company that specializes in the manufacture and distribution of high-quality aluminum products for a range of applications. As a company that prides itself on delivering superior products and exceptional customer service, it is important that Maxi Aluminium has a brand identity that reflects its values and mission.
                    </p>
                    <p class="fn-paragraph-font my-5 opacity-05">
                        The Maxi Aluminium logo is a combination mark that incorporates both strong and curved design elements. The prominent M icon in the focal point of the logo is a bold and powerful representation of the company's name. The strong lines and angles of the M convey a sense of stability and reliability, while the curves of the icon soften the design and add a touch of elegance.
                    </p>
                    <p class="fn-paragraph-font my-5 opacity-05">
                        The color palette of the Maxi Aluminium logo is a deep shade of blue, which is associated with trust, reliability, and professionalism. This color choice reinforces the company's commitment to providing high-quality products and services that customers can depend on.
                    </p>
                    <p class="fn-paragraph-font my-5 opacity-05">
                        Overall, to convey the essence of the company and its offerings, We created a strong and memorable visual representation of the company's brand identity. It conveys the values of stability, reliability, and professionalism, while also incorporating design elements that add a touch of elegance and sophistication.
                    </p>
                    <p class="fn-paragraph-font my-5 opacity-05">
                        What we did - brand identity, logo, printing designs
                    </p>
                </div>
            </div>
            <div class="col-sm-12 col-md-6">
                <div class="row" style="margin-top: 100px">
                    ...
                    <div class="col-sm-6 col-md-4">
                        ...
                        <p class="text-white fn-paragraph-font text-right">Material</p>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    typingEffect([
        'Hair Terminal']); // That u want to show on typing content
    setTimeout(function (){
        $('.once-type').remove();
        $('.once-text-content-append').prepend(`<p class="once-type fn-title-font" >Hair Terminal</p>`)
    },2000);
