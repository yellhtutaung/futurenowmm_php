    ...
    <div class="container-fluid px-0 mx-0">
        <div id="scroll-up-div" class="row" style="margin: 20% 0;" >
            <div class="col-md-6 col-lg-6 col-sm-12 px-0 mx-0 once-text-content-append" >
                ...
                <p class=" fn-paragraph-font">Toward sustainable and innovative housing</p>
            </div>
            <div class="col-sm-12 col-md-6 col-lg-6">
                <div class="row detail-works-sm-margin">
                    ...
                    <div class="col-sm-6 col-md-4 sm-top-divider px-0 mx-0">
                        ...
                        <p class="mb-0 text-white fn-paragraph-font text-right">Real Estate</p>
                    </div>
                </div>
            </div>
        </div>
...
<section class="theme-container" id="get-gallery-div">
    <div class="universal-img-container " data-aos="fade-up" data-aos-duration="1500" >
        <img class="w-100 h-auto" src="<?php echo $domainUrl; ?>/assets/images/projects/v_t/1.jpg" alt="">
    </div>
    <div class="row">
        <div class="col-sm-12 col-md-5 mt-4">
            <div class="universal-img-container"  data-aos="fade-up" data-aos-duration="1500">
                <img class="w-100 h-auto" src="<?php echo $domainUrl; ?>/assets/images/projects/v_t/2.png" alt="">
            </div>
        </div>
        <div class="col-sm-12 col-md-7 mt-4">
            <div class="universal-img-container"  data-aos="fade-up" data-aos-duration="1500">
                <img class="w-100 h-auto" src="<?php echo $domainUrl; ?>/assets/images/projects/v_t/3.jpg" alt="">
            </div>
        </div>
    </div>
    <div class="universal-img-container mt-4" data-aos="fade-up" data-aos-duration="1500" >
        <img class="w-100 h-auto" src="<?php echo $domainUrl; ?>/assets/images/projects/v_t/4.jpg" alt="">
    </div>
    <div class="row">
        <div class="col-sm-12 col-md-4 mt-4">
            <div class="universal-img-container mt-4" data-aos="fade-up" data-aos-duration="1500" >
                <img class="w-100 h-auto" src="<?php echo $domainUrl; ?>/assets/images/projects/v_t/c1.jpg" alt="">
            </div>
        </div>
        <div class="col-sm-12 col-md-4 mt-4">
            <div class="universal-img-container mt-4" data-aos="fade-up" data-aos-duration="1500" >
                <img class="w-100 h-auto" src="<?php echo $domainUrl; ?>/assets/images/projects/v_t/c2.jpg" alt="">
            </div>
        </div>
        <div class="col-sm-12 col-md-4 mt-4">
            <div class="universal-img-container mt-4" data-aos="fade-up" data-aos-duration="1500" >
                <img class="w-100 h-auto" src="<?php echo $domainUrl; ?>/assets/images/projects/v_t/c3.jpg" alt="">
            </div>
        </div>

    </div>
<!--    <div class="universal-img-container mt-4"  data-aos="fade-up" data-aos-duration="1500">-->
<!--        <img class="w-100 h-auto" src="--><?php //echo $domainUrl; ?><!--/assets/images/projects/v_t/6.png" alt="">-->
<!--    </div>-->
    <div class="row">
        <div class="col-sm-12 col-md-8 mt-4">
            <div class="universal-img-container"  data-aos="fade-up" data-aos-duration="1500">
                <img class="w-100 h-auto" src="<?php echo $domainUrl; ?>/assets/images/projects/v_t/7.jpg" alt="">
            </div>
        </div>
        <div class="col-sm-12 col-md-4 mt-4">
            <div class="universal-img-container"  data-aos="fade-up" data-aos-duration="1500">
                <img class="w-100 h-auto" src="<?php echo $domainUrl; ?>/assets/images/projects/v_t/8.png" alt="">
            </div>
        </div>
    </div>
    ...
    <div class="theme-container mt-5">
        ...
        <div class="row" style="margin-top: 150px">
            <div class="col-sm-12 col-md-6">
                <p class="fn-title-font ">V&T Distribution</p>
                <div class="description-section">
                    <p class="fn-paragraph-font my-5 opacity-05">V & T Real Estate is a professional and innovative real estate company that values sustainability and the environment. The brand identity, designed by Future Now, reflects these values through a simple and professional logo that combines a house shape with the letter "G" icon and a green color palette.</p>
                    <p class="fn-paragraph-font my-5 opacity-05">The house shape in the logo represents the core of the company's business - real estate - while the "G" icon adds a personal touch and creates a unique identity. The green color palette further reinforces the company's commitment to sustainability, nature, and environmentally conscious practices.
                    </p>
                    <p class="fn-paragraph-font my-5 opacity-05">Overall, the brand identity for V & T Real Estate is clean, modern, and memorable. It communicates the company's dedication to providing excellent real estate services while also promoting sustainability and environmental responsibility.
                    </p>
                    <p class="fn-paragraph-font my-5 opacity-05">What we did: Brand identity, Printing Design</p>
                </div>
            </div>
            <div class="col-sm-12 col-md-6">
                <div class="row" style="margin-top: 100px">
                    ...
                    <div class="col-sm-6 col-md-4">
                        ...
                        <p class="text-white fn-paragraph-font text-right">Real Estate</p>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    typingEffect([
        'V&T Distribution']); // That u want to show on typing content
    setTimeout(function (){
        $('.once-type').remove();
        $('.once-text-content-append').prepend(`<p class="once-type fn-title-font" >V&T Distribution</p>`)
    },2000);
