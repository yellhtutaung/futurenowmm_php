...
<!--                    </svg>-->
                    <img style="width: 180px!important;height: 37px !important;" class="header-logo" src="<?php echo $domainUrl; ?>/assets/images/logo/fn-logo.svg" alt="">
                </a>
            </li>
            ...
            <li class="nav-list d-none hambager-div " style="padding: 20px 0 20px 31%;margin-right: 0;" >
                <div class="w-100 hambager-menu mt-3">
                    <div class="bar float-right"></div>
<!--                    <div class="bar"></div>-->
<!--                    <div class="bar"></div>-->
                </div>
            </li>
...
<div id="navbar_overlay" class="overlay" style="height: 0%;" >
    <div href="javascript:void(0) " onclick="overlayClose()" class="closebtn text-white p-0">
        <span style="font-size: 50px;" class="text-white material-symbols-rounded">close</span>
    </div>
    <div class="overlay-content">
<!--        <img style="width: 180px!important;height: 37px !important;" class="header-logo" src="--><?php //echo $domainUrl; ?><!--/assets/images/logo/fn-logo.svg" alt="">-->

        <a href="<?php echo $domainUrl;?>"><p class="hambager-menu-text mb-0 pb-0 text-white" >Home</p></a>
        <a href="<?php echo $domainUrl;?>/about.php"><p class="hambager-menu-text mb-0 pb-0 text-white" >About</p></a>
        <a href="<?php echo $domainUrl;?>/works.php"><p class="hambager-menu-text mb-0 pb-0 text-white">Works</p></a>
        <a href="<?php echo $domainUrl;?>/job.php"><p class="hambager-menu-text mb-0 pb-0 text-white">Jobs</p></a>
        <a href="<?php echo $domainUrl;?>/news.php"><p class="hambager-menu-text mb-0 pb-0 text-white">News</p></a>
        <a href="<?php echo $domainUrl;?>/contact.php"><p class="hambager-menu-text mb-0 pb-0 text-white">Contact Us </p></a>
            <p style="font-size: 15px; text-align: right!important;float: right!important;" class="text-white text-right float-right p-0 m-0 mt-5 ">Helping brands since 2018</p>
        <div class="overlay-footer ">
            <div class="d-flex text-left">
                <p class="m-0 d-inline text-white animatable fadeInUp fn-paragraph-font ">
                    <u>Facebook</u></p>
                <p class="ml-2 d-inline text-white animatable fadeInUp fn-paragraph-font ">
                    <u>Instagram</u> </p>
            </div>
        </div>
    </div>
...
<script>
    ...
    if (screen.width < 915 )
    {
        ...
        $('.header-logo').attr("style","width: 140px!important;height: 37px !important;");
    }
